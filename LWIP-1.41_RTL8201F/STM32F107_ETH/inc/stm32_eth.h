...
/**
  * @}
  */
#define	PHY_ANLPAR_100TXFD			      	 ((u16)0x0100)		//* 连接方支持100Base-TX全双工
#define	PHY_ANLPAR_100TX			         ((u16)0x0080)		//* 连接方支持100Base-TX
#define	PHY_ANLPAR_10TXFD			         ((u16)0x0040)		//* 连接方支持10Base-T全双工
#define PHY_ANLPAR_10TX				         ((u16)0x0020)		//* 连接方支持10Base-TX
