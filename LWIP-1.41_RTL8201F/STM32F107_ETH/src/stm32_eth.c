...
/**
* @brief根据指定初始化ETHERNET外设
   * ETH_InitStruct中的参数。
   * @param ETH_InitStruct：指向包含的ETH_InitTypeDef结构的指针
   *指定以太网外围设备的配置信息。
   * @param PHYAddress：外部PHY地址
   * @retval ETH_ERROR：以太网初始化失败
   * ETH_SUCCESS：以太网成功初始化              
  */
// PHY Status Register
